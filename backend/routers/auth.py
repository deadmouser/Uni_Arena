...
async def register(user_data: UserCreate, db: Session = Depends(get_db)):
    """Register a new user - DISABLED: Only admins can create users"""
    raise HTTPException(
        status_code=status.HTTP_403_FORBIDDEN,
        detail="Registration is disabled. Please contact your institution administrator for account access."
    )
